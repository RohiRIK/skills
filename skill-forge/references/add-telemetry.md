...
Exclude **Tier-A reference skills** (passive knowledge — they have no action workflows to instrument). A reference skill with a `references/` dir is rare; if its "workflow" only describes lookups, skip it.
