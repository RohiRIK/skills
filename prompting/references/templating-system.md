...
└── scripts/                # RenderTemplate.ts, ValidateTemplate.ts
```

## Rendering

```bash
bun ~/.claude/skills/Prompting/scripts/RenderTemplate.ts \
...
```typescript
import { renderTemplate } from '~/.claude/skills/Prompting/scripts/RenderTemplate.ts';
