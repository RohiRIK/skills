...
description: "Use when reference for context compaction strategy and timing guidance."
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [reference]
    related_skills: []
usage_hint: "After loading this skill, immediately call skill_view(name='strategic-compact', file_path='references/run-compact.md') before taking any action."
---
