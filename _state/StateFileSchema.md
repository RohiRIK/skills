...
- **`## Dead Ends` is binding.** Any approach listed there is never attempted again. An approach moves here after it fails twice (Iterate) or after it is evicted (Orchestrate MergeQueue) with the reason recorded.
