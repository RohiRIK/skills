...
bun ~/.claude/skills/CORE/scripts/remove-bg.ts /path/to/output.png

# Or batch process multiple images
bun ~/.claude/skills/CORE/scripts/remove-bg.ts image1.png image2.png image3.png
```

**See:** `~/.claude/skills/Images/references/background-removal.md` for full documentation.
