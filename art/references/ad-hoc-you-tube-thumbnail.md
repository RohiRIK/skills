...
bun ~/.claude/skills/Headshot/scripts/headshot.ts \
...
```bash
bun ~/.claude/skills/CORE/scripts/remove-bg.ts ~/Downloads/yt-headshot-${TIMESTAMP}.png
```
...
```bash
bun ~/.claude/skills/Art/scripts/compose-thumbnail.ts \
