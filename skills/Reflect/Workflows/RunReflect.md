...
**Inside a Iterate:** don't print the full card — write the overall score to `.agent-state.md` for the current iteration (the score steers the next pass and feeds the exit check at ≥ 4.5). See `Iterate/StateFileSchema.md`.
